...
results_file <- file.path(here(), "private", 
...
codes_to_exclude <- read_csv(file.path(here(), "data", "codes_to_exclude.csv"))
...
write_csvy(results, file = file.path(here(), "data", "results_clean.csv"),
           metadata = file.path(here(), "data", "results_clean.yaml"), na = "NA")
```
...
saveRDS(completed_summary, file.path(here(), "data", "completion_summary.rds"))
write_csv(completed_summary, file.path(here(), "data", "completion_summary.csv"))
```
