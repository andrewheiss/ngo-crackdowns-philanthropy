...
# Filter to convert pandoc-generated longtable elements to tabular elements.
#
# usage: pandoc document.md -o document.tex --filter tabularize.py
#
# I copied this from Wagner Macedo's original filter at:
# https://groups.google.com/forum/#!msg/pandoc-discuss/RUC-tuu_qf0/h-H3RRVt1coJ
# 
# I made two adjustments to the original script:
# - Use `table*` instead of `table` to span two columns in SAGE LaTeX template
# - Surround table with \small and \normalize to shrink the text a little
