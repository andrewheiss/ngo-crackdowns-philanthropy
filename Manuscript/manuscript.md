...
We argue that structural factors such as host country politics—in particular, restrictions on NGOs—serve as important shortcuts and heuristics to determine the trustworthiness of NGOs. While in theory, perfectly rational donors would scrutinize each aspect of a nonprofit’s structure and institutional environment prior to donation, this rarely occurs in practice [@Tremblay-BoirePrakash:2017]. Instead, literature has shown that donors rely on shortcuts and heuristics to determine the trustworthiness of NGOs. Donors make cursory judgmentss about an organization's issue area, mission, vision, and values and seek out supplementary information from friends, family, and acquaintances [@SzperPrakash:2011; @Sloan:2009]. 
