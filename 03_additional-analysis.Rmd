...
# 
# Stupid bleeding environments
# https://github.com/andrewheiss/rmarkdown-website-envs-orig
if (isTRUE(getOption('knitr.in.progress')) & !is.null(names(sessionInfo()$otherPkgs))) {
  ...
  # THIS IS SO EVIL AND AWFUL BUT NECESSARY BECAUSE STUFF HAPPENS IN PREVIOUS
  # FILES THAT BREAK THIS FILE WHEN IT IS KNIT AS PART OF AN RMARKDOWN WEBSITE
  #
  # DON'T TELL JENNY BRYAN
  rm(list = ls())
  # AHHH THE HORROR
}
